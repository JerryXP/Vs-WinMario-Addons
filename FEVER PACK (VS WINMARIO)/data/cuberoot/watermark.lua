   --hello, this is called "watermark.lua" this is where the watermark will show up ehn the song appears.
   --and no this is not a global script (ex: luaScript/) this is a separated script so please put it under
   --(data/your-song-name/) and i highly reccomended you copy and paste this script.
   --credits to: Sebbat
   --message made by: me (WM/LXP)
   ...
   --easy script configs
    ...
    IntroTagColor = 'C0C000' --Color of the tag at the end of the box.
    ...
    function onCreate()
        ...
        makeLuaText('JukeBoxSubText', 'Cuberoot', 300, -305-IntroTagWidth, 220)
        ...
        makeLuaText('JukeBoxSubText2', 'AadstaPinwheel', 300, -305-IntroTagWidth, 260)
