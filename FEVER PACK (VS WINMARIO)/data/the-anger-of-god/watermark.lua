   ...
   --easy script configs
    ...
    IntroTagColor = '804000' --Color of the tag at the end of the box.
    ...
    function onCreate()
        ...
        makeLuaText('JukeBoxSubText', 'The Anger of God', 300, -305-IntroTagWidth, 220)
        ...
        makeLuaText('JukeBoxSubText2', 'Lyfer!', 300, -305-IntroTagWidth, 260)
