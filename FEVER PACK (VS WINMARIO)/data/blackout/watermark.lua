   ...
   --easy script configs
    ...
    IntroTagColor = '40FF00' --Color of the tag at the end of the box.
    ...
    function onCreate()
        ...
        makeLuaText('JukeBoxSubText', 'Blackout', 300, -320-IntroTagWidth, 220)
        ...
        makeLuaText('JukeBoxSubText2', 'Cval', 300, -305-IntroTagWidth, 260)
