   ...
   --easy script configs
    ...
    IntroSubText2Size = 15 --size of the text for the Artist Name.
    ...
    function onCreate()
        ...
        makeLuaText('JukeBoxSubText', 'It\'s-a-Me', 300, -305-IntroTagWidth, 220)
        ...
        makeLuaText('JukeBoxSubText2', 'theWAHbox (ft. Sandi, antinarious, & Comodo_)', 300, -305-IntroTagWidth, 260)
