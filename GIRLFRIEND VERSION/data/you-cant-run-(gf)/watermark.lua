   ...
   --easy script configs
    ...
    IntroTagColor = '800040' --Color of the tag at the end of the box.
    ...
    function onCreate()
        ...
        makeLuaText('JukeBoxSubText', 'You Cant Run', 300, -305-IntroTagWidth, 220)
        ...
        makeLuaText('JukeBoxSubText2', 'MarStarBro', 300, -305-IntroTagWidth, 260)
