   ...
   --easy script configs
    ...
    IntroTagColor = 'c080ff' --Color of the tag at the end of the box.
    ...
    function onCreate()
        ...
        makeLuaText('JukeBoxSubText', 'Bad Time', 300, -305-IntroTagWidth, 220)
        ...
        makeLuaText('JukeBoxSubText2', 'Tenzubushi & Anjer 2', 300, -305-IntroTagWidth, 260)
