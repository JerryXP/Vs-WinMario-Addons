   ...
   --easy script configs
    ...
    IntroSubText2Size = 18 --size of the text for the Artist Name.
    ...
    function onCreate()
        ...
        makeLuaText('JukeBoxSubText', 'Remembrance', 300, -305-IntroTagWidth, 220)
        ...
        makeLuaText('JukeBoxSubText2', 'CheeseWithCake & myakish', 300, -305-IntroTagWidth, 260)
