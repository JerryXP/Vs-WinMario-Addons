   ...
   --easy script configs
    ...
    IntroTagColor = 'ff4000' --Color of the tag at the end of the box.
    ...
    function onCreate()
        ...
        makeLuaText('JukeBoxSubText', 'Win-Blammed', 300, -305-IntroTagWidth, 220)
        ...
        makeLuaText('JukeBoxSubText2', 'Kawai Sprite & Biddle3', 300, -305-IntroTagWidth, 260)
