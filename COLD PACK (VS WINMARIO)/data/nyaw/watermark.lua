   ...
   --easy script configs
    ...
    IntroTagColor = '00c000' --Color of the tag at the end of the box.
    ...
    function onCreate()
        ...
        makeLuaText('JukeBoxSubText', 'Nyaw', 300, -305-IntroTagWidth, 220)
        ...
        makeLuaText('JukeBoxSubText2', 'PaperKitty', 300, -305-IntroTagWidth, 260)
