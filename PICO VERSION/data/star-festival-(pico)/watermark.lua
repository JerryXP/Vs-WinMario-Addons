   ...
   --easy script configs
    ...
    IntroSubTextSize = 32 --size of the text for the Song Name.
    IntroSubText2Size = 20 --size of the text for the Artist Name.
    IntroTagColor = '00ff80' --Color of the tag at the end of the box.
    ...
    function onCreate()
        ...
        makeLuaText('JukeBoxSubText', 'Star Festival', 300, -305-IntroTagWidth, 220)
        ...
        makeLuaText('JukeBoxSubText2', 'Powerhaus & Luminator', 300, -305-IntroTagWidth, 260)
